        ...
        foreach ([
            [
                ...
                'map' => [
                    ...
                    'top_right_x' => 0.6280,
                    'top_right_y' => 0.2311,
                    'bottom_right_x' => 0.6259,
                    'bottom_right_y' => 0.6274,
                    'bottom_left_x' => 0.3384,
                    'bottom_left_y' => 0.6274,
            ...
            [
                ...
                'map' => [
                    ...
                    'top_right_x' => 0.6983,
                    'top_right_y' => 0.1455,
                    'bottom_right_x' => 0.6977,
                    'bottom_right_y' => 0.5440,
                    'bottom_left_x' => 0.4129,
                    'bottom_left_y' => 0.5440,
                    'normalized_coordinates' => true,
                    'coordinate_space' => 'image',
                    'manual_rotation' => 0,
                    'shadow_strength' => 0.18,
            ...
            [
                ...
                'map' => [
                    ...
                    'top_right_x' => 0.7613,
                    'top_right_y' => 0.2252,
                    'bottom_right_x' => 0.7397,
                    'bottom_right_y' => 0.7034,
                    'bottom_left_x' => 0.4499,
                    'bottom_left_y' => 0.6731,
                    'normalized_coordinates' => true,
                    'coordinate_space' => 'image',
                    'manual_rotation' => -1.5,
