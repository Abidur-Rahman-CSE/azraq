...
class PersonalizationTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fields.*.settings.prefix_bold'        => ['nullable', 'boolean'],
            'fields.*.settings.prefix_italic'      => ['nullable', 'boolean'],
            'fields.*.settings.prefix_size'        => ['nullable', 'numeric', 'min:0', 'max:200'],
            ...
            'fields.*.settings.postfix_bold'       => ['nullable', 'boolean'],
            'fields.*.settings.postfix_italic'     => ['nullable', 'boolean'],
            'fields.*.settings.postfix_size'       => ['nullable', 'numeric', 'min:0', 'max:200'],
