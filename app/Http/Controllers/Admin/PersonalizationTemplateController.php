        ...
        collect($data['fields'] ?? [])
            ...
            ->each(fn (array $field, int $index) => $template->fields()->create([
                ...
                'settings' => [
                    ...
                    'prefix_bold'        => (bool)  data_get($field, 'settings.prefix_bold', false),
                    'prefix_italic'      => (bool)  data_get($field, 'settings.prefix_italic', false),
                    ...
                    'postfix_bold'       => (bool)  data_get($field, 'settings.postfix_bold', false),
                    'postfix_italic'     => (bool)  data_get($field, 'settings.postfix_italic', false),
